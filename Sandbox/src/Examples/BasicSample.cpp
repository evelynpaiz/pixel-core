 ...
 */
void BasicSample::OnUpdate(pixc::Timestep ts)
{
...
void BasicSample::OnAttach()
{
    ...
    std::vector<SimpleVertex> vertices = {
        { glm::vec4(-0.5f, -0.5f, 0.0f, 1.0f), glm::vec2(0.0f, 0.0f) },   // left
        { glm::vec4( 0.5f, -0.5f, 0.0f, 1.0f), glm::vec2(1.0f, 0.0f) },   // right
        { glm::vec4( 0.0f,  0.5f, 0.0f, 1.0f), glm::vec2(0.5f, 1.0f) }    // top
    };
    ...
    pixc::BufferLayout layout =
    {
        ...
        { "a_TextureCoord", { pixc::DataType::Vec2 } }
    };
 ...
 * @param e Event.
 */
void BasicSample::OnEvent(pixc::Event& e)
{
    // Define the event dispatcher
    pixc::EventDispatcher dispatcher(e);
    // Dispatch the event to the application event callbacks
    dispatcher.Dispatch<pixc::WindowResizeEvent>(BIND_EVENT_FN(BasicSample::OnWindowResize));
}
 ...
 */
bool BasicSample::OnWindowResize(pixc::WindowResizeEvent &e)
{
